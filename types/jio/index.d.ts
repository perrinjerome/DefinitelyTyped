...
/**
 * XXX the patched version of RSVP that jio uses.
 */
...
declare interface SimpleQuery extends Query {
    key: string;
    value: any;
    type: "simple";
}

declare interface ComplexQuery extends Query {
    query_list: Query[];
    operator: "AND" | "OR";
    type: "complex";
}

declare type IQuery = SimpleQuery | ComplexQuery;

declare interface AllDocsQuery {
    /**
     * the query
     */
    query: IQuery;
...
export namespace jIO {
    /**
     * `createJIO`
     * Initialize a new storage or storage tree, synchronously.
     * @param configuration the configuration to use.
     */
    function createJIO(configuration: LocalStorageConfiguration): LocalStorage;
    function createJIO(
    ...
    function createJIO(configuration: ERP5StorageConfiguration): ERP5Storage;
    function createJIO(configuration: ZipStorageConfiguration): ZipStorage;
    function createJIO(configuration: ShaStorageConfiguration): ShaStorage;
    function createJIO(configuration: UuidStorageConfiguration): UuidStorage;
    function createJIO(configuration: QueryStorageConfiguration): QueryStorage;
    function createJIO(configuration: CryptStorageConfiguration): CryptStorage;
    function createJIO(configuration: UnionStorageConfiguration): UnionStorage;
    function createJIO(
 ...
 */
declare class LocalStorage extends jIOStorage {}
 ...
 */
declare class WebDavStorage extends jIOStorage {}
 ...
 */
declare class DropboxStorage extends jIOStorage {}
 ...
 */
declare class GoogleDriveStorage extends jIOStorage {}
 ...
 */
declare class CryptStorage extends jIOStorage {}
 ...
 */
declare class UnionStorage extends jIOStorage {}
 ...
 */
declare class DocumentStorage extends jIOStorage {}

/**
 * Synchronize documents between a local and a remote storage by providing the repair method.
 */
declare class ReplicateStorage extends jIOStorage {}
